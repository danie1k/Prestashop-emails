...
<p>{l s='Your order on %s is complete.' sprintf=$shop_name mod='bankwire'}
		<br /><br />{l s='Please send us a bank wire with' mod='bankwire'}
		<br /><br /><span class="before-strong">- {l s='Amount' mod='bankwire'}</span> <strong>{$total_to_pay}</strong>
		<br /><br /><span class="before-strong">- {l s='Name of account owner' mod='bankwire'}</span> <strong>{if $bankwireOwner}{$bankwireOwner}{else}___________{/if}</strong>
		<br /><br /><span class="before-strong">- {l s='Include these details' mod='bankwire'}</span> <strong>{if $bankwireDetails}{$bankwireDetails}{else}___________{/if}</strong>
		<br /><br /><span class="before-strong">- {l s='Bank name' mod='bankwire'}</span> <strong>{if $bankwireAddress}{$bankwireAddress}{else}___________{/if}</strong>
		{*
			{if !isset($reference)}
			...
			{/if}
		*}
		<br /><br /><span class="before-strong">- {l s='Bank wire subject' mod='bankwire'}</span> <strong>{l s='Order' mod='bankwire'} #{$id_order}</strong>
